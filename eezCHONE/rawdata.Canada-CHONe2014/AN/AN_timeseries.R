library(dplyr)
food_gas_data=read.csv('eezCHONE/rawdata.Canada-CHONe2014/AN/aboriginal_food_gas.csv')
ice_layer=read.csv("eezCHONE/rawdata.Canada-CHONe2014/AN/ice_layer.csv")
...
write.csv(ANmean2,'eezCHONE/rawdata.Canada-CHONe2014/AN/AN_timeseries.csv',row.names=F)
